...
ENV RUST_SERVER_DESCRIPTION "This is a Rust Server!"
ENV RUST_SERVER_URL "https://github.com/Skyleiger/Docker-Rust-Server"
ENV RUST_SERVER_BANNER_URL ""
ENV RUST_RCON_WEB "1"
ENV RUST_RCON_PORT "28016"
ENV RUST_RCON_PASSWORD "rust"
